...
<head>
    ...
    <link rel="stylesheet" href="{{ asset(env('ASSET_URL') .'plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')}}">
    <!-- iCheck -->
    ...
    <!-- overlayScrollbars -->
    <link rel="stylesheet" href="{{ asset(env('ASSET_URL') .'plugins/overlayScrollbars/css/OverlayScrollbars.min.css')}}">
    <!-- Daterange picker -->
...
<div class="wrapper">
    ...
    <!-- Navbar -->
    <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background-color:#11D06B;">
        <!-- Left navbar links -->
        <ul class="navbar-nav">
            <li class="nav-item">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4 bg-white">
        ...
        <a href="index3.html" class="brand-link">
            <img src="{{asset('images/fleetgreen.png')}}" alt="AdminLTE Logo" class="brand-image  "
                 style="opacity: .8">
            <span class="brand-text font-weight-light text-white">Fleet</span>
        </a>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="driver-index" class="nav-link">
                                    ...
                                    <p class="text-dark">All Drivers</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="driver-pending" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p class="text-dark">Pending Request</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="driver-create" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p class="text-dark">Add Drivers</p>
                                </a>
                            </li>
                        </ul>
                    </li>
...
{{--                                <i class="right fas fa-angle-left"></i>--}}
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="category-index" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p class="text-dark">All Categories</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="category-create" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p class="text-dark">Add Categories</p>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="ride-index" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p class="text-dark">All Rides</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="ride-completed" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p class="text-dark">Completed Rides</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="ride-active" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p class="text-dark">Active Rides</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="ride-cancel" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p class="text-dark">Cancel Rides</p>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class=" nav-item">
                        <a href="university-index" class=" nav-link ">
                            <i class="nav-icon fas fa-tachometer-alt text-dark"></i>
                            <p class="text-dark">
                                University
{{--                                <i class="right fas fa-angle-left"></i>--}}
                    ...
                    <li class=" nav-link @yield('dashboard_nav')">
...
{{--                        <li class="nav-link  @yield('add_category_nav')">--}}
...
{{--                        </li>--}}
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('cuisine.index')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>All Cuisines</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('cuisine.create')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add Cuisine</p>
                                    </a>
                                </li>
...
<script src="{{ asset(env('ASSET_URL') .'plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js')}}"></script>
<!-- Summernote -->
